...
<?php
		...
		if(!$row)
		{
			echo '<div style="text-align:center;"><font size="10" color="red">Username Or Password Incorrect</font></div>';
			echo '<div style="text-align:center;">Wait For Login Again</div>';
